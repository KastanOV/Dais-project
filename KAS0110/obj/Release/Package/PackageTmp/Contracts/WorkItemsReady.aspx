...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PneuservisConnectionString %>" InsertCommand="INSERT INTO [WorkItemsReady] ([Name], [Description], [Price]) VALUES (@Name, @Description, @Price)" SelectCommand="SELECT [Name], [Description], [Price], [id] FROM [WorkItemsReady]" UpdateCommand="UPDATE [WorkItemsReady] SET [Name] = @Name, [Description] = @Description, [Price] = @Price WHERE [id] = @original_id AND [Name] = @original_Name AND [Description] = @original_Description AND [Price] = @original_Price" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [WorkItemsReady] WHERE [id] = @original_id AND [Name] = @original_Name AND [Description] = @original_Description AND [Price] = @original_Price" OldValuesParameterFormatString="original_{0}">
        <DeleteParameters>
